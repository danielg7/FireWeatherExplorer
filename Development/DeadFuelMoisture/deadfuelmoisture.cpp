    ...
    )
{
	...
	double tfract, ta, ha, sv, bp, fsc, tka, tdw, tdp, tsk, hr, sr, psa,pa,psd, tfd, qv, qw, hw, tkf, gnu, c1, c2, wdiff, ps1, p1, hf_log,
		bi, aml, s_new, w_new, w_old, svp, ak, ae, aw, ar, ap;
 ...
 */
namespace Sem{
ostream& operator<<( ostream& output, const Sem::DeadFuelMoisture& r )
{
 ...
 */
namespace Sem{
istream& operator>>( istream& input, Sem::DeadFuelMoisture& r )
{
    string vname;
    int i, n;
